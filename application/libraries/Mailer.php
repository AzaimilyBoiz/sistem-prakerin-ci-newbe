...
{
	protected $_ci;
	protected $email_pengirim = 'suklioaoe@gmail.com'; // Isikan dengan email pengirim
	protected $nama_pengirim = 'Admin Sistem Informasi PKL'; // Isikan dengan nama pengirim
	protected $password = 'uzumakinaruto'; // Isikan dengan password email pengirim
	...
	public function send($data)
	{
		...
		$mail->AddEmbeddedImage('image/logo.png', 'logo_smk', 'logo.png'); // Aktifkan jika ingin menampilkan gambar dalam email

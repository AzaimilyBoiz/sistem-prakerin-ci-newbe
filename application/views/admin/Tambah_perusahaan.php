...
<body>
    ...
    <div class="col-md-10 p-5 pt-2">
        ...
        <div class="table-responsive">
            <button class="btn btn-primary" type="submit" form="tambah-perusahaan">Simpan</button>

            <form action="<?php echo base_url('tambah_perusahaan/simpan_perusahaan/'); ?>" method="post"
                ...
                <table class="table table-bordered table-hover">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="alamat" id="alamat" placeholder="Masukan alamat perusahaan"
                                    required>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="rekomendasi" id="rekomendasi"
                                    placeholder="Masukan rekomendasi jurusan" required>
                            </td>
                        </tr>
                    </tbody>
                </table>

...
<body>
    ...
    <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-5 pt-2">
            <h3><i class="fas fa-chalkboard-teacher mr-1"></i>Daftar Guru</h3>
            ...
            <?php endif; ?>
            <br>
            <a class="btn btn-primary" href="<?php echo base_url('Admin/Dashboard/Tambah_guru'); ?>">Tambah Data
                Guru</a>
            <br>
            <?php $attributes = array('class' => 'row'); ?>
            <?php echo form_open('Admin/Dashboard/search_guru', $attributes); ?>
            ...
            <a href="<?= base_url('Admin/Dashboard/daftar_guru') ?>" class="btn btn-warning col-md-1">Reset</a>
            <?php echo form_close(); ?>
            <br>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary"
                                    href="<?php echo base_url('Admin/Dashboard/Edit_guru/' . $gu->id_guru); ?>">Edit</a>
                                <a class="btn btn-danger"
                                    href="<?php echo base_url('Admin/Dashboard/Hapus_guru/' . $gu->id_guru); ?>">Hapus</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                        <?php else : ?>

...
<body>
    ...
    <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-5 pt-2">
            <h3><i class="far fa-envelope"></i> Kirim Email
            </h3>
            <br>
            <?= $this->session->flashdata('message'); ?>
            <?php echo form_open('Admin/Dashboard/send', ['method' => 'post', 'enctype' => 'multipart/form-data']) ?>
            <div class="form-group">
                <label for="kepada">Kepada</label>
                <input type="email" class="form-control" id="email" name="email_penerima"
            ...
            <div class="form-group">
                <label for="attachment">Attachment<small>(.doc, .docx, .pdf)</small></label>
